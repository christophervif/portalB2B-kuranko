...
module.exports = function registrarConciliacion({ app, authAdmin, mConc, prodPool, VV }) {
  ...
  app.get('/api/conciliacion-sheet', authAdmin, mConc, async (req, res) => {
    try {
  ...
  app.get('/api/conciliacion-sistema', authAdmin, mConc, async (req, res) => {
    const { desde, hasta } = req.query;
